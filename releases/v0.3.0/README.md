# ArenaOS v0.3.0 — QEMU run bundle
...
the release (https://github.com/zeromike12/ArenaOS/releases/tag/v0.3.0)
links this in-repo bundle instead.

## Download

```sh
curl -LO https://github.com/zeromike12/ArenaOS/raw/refs/heads/arena/01a0d6fd-arenaos/releases/v0.3.0/arenaos-v0.3.0-qemu-x86_64.tar.gz
sha256sum -c arenaos-v0.3.0-qemu-x86_64.tar.gz.sha256

# or via the GitHub API (contents endpoint caps at 1 MiB — use the blob):
gh api repos/zeromike12/ArenaOS/git/blobs/22d0bafc9609cb2d0854cd8bca1dc32ef0552531 \
    -H "Accept: application/vnd.github.raw" > arenaos-v0.3.0-qemu-x86_64.tar.gz
```

## Run

```sh
tar xzf arenaos-v0.3.0-qemu-x86_64.tar.gz
